...
export default async function CollegeDetail({
  ...
  return (
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <Link
        href="/colleges"
        className="inline-flex items-center gap-1.5 text-sm text-[var(--text-muted)] hover:text-[var(--amber)] mb-6 transition-colors"
      >
      ...
      <div className="relative rounded-2xl overflow-hidden h-56 sm:h-72 mb-8">
        ...
        <div className="absolute bottom-0 p-6">
          ...
          <p className="text-xs text-[var(--amber)] font-medium mb-1 uppercase tracking-wider">
            {college.type} · NIRF #{college.ranking.nirf}
          </p>
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-5">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-[var(--navy-700)] rounded-xl p-3 text-center">
                ...
                <p className="font-display font-bold text-lg text-[var(--amber)]">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {college.placements.topRecruiters.map((recruiter) => (
                ...
                <span
                  key={recruiter}
                  className="px-3 py-1 bg-[var(--navy-700)] border border-[var(--border)] rounded-full text-xs text-[var(--text-secondary)]"
                >
                  {recruiter}
                </span>
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-5">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {college.courses.map((course) => (
                ...
                <span
                  key={course}
                  className="px-3 py-1.5 bg-[var(--navy-700)] border border-[var(--border)] rounded-lg text-sm text-[var(--text-secondary)]"
                >
                  {course}
                </span>
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--border)] rounded-2xl p-5">
            ...
            {college.cutoffs.map((cutoff) => (
              ...
              <div
                key={cutoff.exam}
                className="bg-[var(--navy-700)] rounded-xl p-4 mb-3"
              >

                <p className="text-sm font-medium text-[var(--amber)] mb-3">
                  {cutoff.exam}
                </p>
                ...
                <div className="grid grid-cols-3 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium mt-0.5">
                      {cutoff.generalRank.toLocaleString()}
                    </p>
